...
<body ng-app="ui" ng-controller="MainController as main" ng-cloak layout="column">

<md-content ng-if="main.loaded" ng-include="'partials/main.html'" layout="column" flex></md-content>

<script src="socket.io/socket.io.js"></script>
<ui-component style="display:none;" ng-repeat="control in main.scripts" flex item="control">
    
</ui-component>
<script src="../js/UI/head.js"></script>
<!-- build:js -->
<script src="vendor/jquery/dist/jquery.min.js"></script>
<script src="vendor/jquery-bridget/jquery.bridget.js"></script>
<script src="vendor/masonry-layout/dist/masonry.pkgd.min.js"></script>
...
<script src="vendor/angular-masonry/angular-masonry.min.js"></script>

<!--for charts-->
<script src="vendor/d3/d3.min.js"></script>
<script src="vendor/nvd3/build/nv.d3.min.js"></script>
<script src="vendor/angularjs-nvd3-directives/dist/angularjs-nvd3-directives.min.js"></script>
...
<script src="directives/ui-compile.js"></script>
