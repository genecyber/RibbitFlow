!function () {
    ...
    function b(a, b) {
        for (var c = a.className; -1 != c.indexOf(b); )
            c = c.replace(b, ""),
            c = c.trim();
        a.className = c
    }
    ...
    e = window[g],
    e.explorerUrl = "https://static-cdn.kloudless.com/p/platform/explorer/explorer.html",
    e._frames = {},
    e._explorers = {},
    e._queuedAction = {};
    var h = e._frames
    ...
    m.type = "text/css",
    m.styleSheet ? m.styleSheet.cssText = n : m.appendChild(document.createTextNode(n)),
    ...
    function () {
        ...
        window.addEventListener("message", function (a) {
            if (a.origin === b) {
                var c, d = JSON.parse(a.data), f = d.exp_id;
                c = e._explorers[f],
                c && c._fire.apply(c, [d.action, d.data])
            }
        }
        )
    }
    ...
    var o = function (b, d) {
        ...
        c() && g.setAttribute("scrolling", "no"),
        g.setAttribute("class", "kloudless-modal"),
        g.setAttribute("src", e.explorerUrl + "?app_id=" + b.app_id + "&exp_id=" + f + "&flavor=" + b.flavor + "&origin=" + encodeURIComponent(window.location.protocol + "//" + window.location.host) + "&multiselect=" + b.multiselect + "&link=" + b.link + "&direct_link=" + b.direct_link + "&computer=" + b.computer + "&copy_to_upload_location=" + b.copy_to_upload_location + "&services=" + JSON.stringify(b.services) + "&persist=" + JSON.stringify(b.persist) + "&account_key=" + b.account_key + "&create_folder=" + b.create_folder + "&types=" + JSON.stringify(b.types)),
    ...
    e._fileWidget.prototype._setOptions = function (a) {
        ...
        this.app_id = a.app_id,
        this.exp_id = a.exp_id,
        this.elementId = a.elementId,
        this.flavor = void 0 === a.flavor ? "chooser" : a.flavor,
        this.multiselect = void 0 === a.multiselect ? !1 : a.multiselect,
        this.link = void 0 === a.link ? !0 : a.link,
        this.direct_link = void 0 === a.direct_link ? !1 : a.direct_link,
        this.computer = void 0 === a.computer ? !1 : a.computer,
        this.copy_to_upload_location = void 0 === a.copy_to_upload_location ? !1 : a.copy_to_upload_location,
        this.create_folder = void 0 === a.create_folder ? !0 : a.create_folder,
        this.account_key = void 0 === a.account_key ? !1 : a.account_key,
        this.persist = void 0 === a.persist ? "local" : a.persist,
        this.display_backdrop = void 0 === a.display_backdrop ? !1 : a.display_backdrop,
        this.services = a.services || null ,
        this.files = a.files || [],
        this.types = a.types || [],
        this.files instanceof Array || (this.files = []),
        this.types instanceof Array || (this.types = [this.types]),
        this.types = this.types.map(function (a) {
    ...
    e._fileWidget.prototype.on = function (a, b) {
        return void 0 === this.handlers[a] && (this.handlers[a] = []),
    ...
    e._fileWidget.prototype._fire = function (a, b) {
        var c = this;
        -1 != ["success", "cancel"].indexOf(a) && c.close();
        ...
        if (d && window.setTimeout(function () {
            ...
            , 0),
            void 0 !== c.handlers[a])
            for (var e = 0; e < c.handlers[a].length; e++)
                !function (a) {
    ...
    e.explorer = function (a) {
        ...
        b.on("load", function () {
            if (b.message("INIT", null),
            b.loaded = !0,
            j[b.exp_id]) {
                var a = j[b.exp_id].method
                  , c = j[b.exp_id].args;
                delete j[b.exp_id],
                a.apply(b, c)
            }
        ...
        return b.exp_id = c,
        b.defaultHandlers.close = function () {
            var a = h[b.exp_id];
            p.fadeOut(a, {
                duration: 200,
                complete: function () {
    ...
    ,
    e._explorer.prototype = Object.create(e._fileWidget.prototype),
    e._explorer.prototype.constructor = e._explorer,
    Object.defineProperty(e._explorer.prototype, "constructor", {
        enumerable: !1,
        value: e._explorer
    }),
    ...
    e._explorer.prototype.save = function (a) {
        var b = this;
        return b.loaded ? (a instanceof Array || (a = []),
        a = b.files.concat(a),
        a.length < 1 ? void console.log("ERROR: No files to save") : (b._open({
            flavor: "saver",
            files: a
        }),
        b)) : void (j[b.exp_id] = {
    ...
    e._explorer.prototype._open = function (b) {
        ...
        return b.options = this.options,
        d.message("DATA", b),
        e._fileWidget.lastScrollTop = f.scrollTop,
        c() && (f.scrollTop = 0),
        h[d.exp_id].style.display = "block",
        h[d.exp_id].style.opacity = 0,
        a(f, "kfe-active"),
        p.fadeIn(h[d.exp_id], {
            duration: 200
        }),
        d.display_backdrop && (k.style.display = "block",
        l = f.style.overflow,
    ...
    e._explorer.prototype.close = function () {
        ...
        if (!a.loaded)
            return void (j[a.exp_id] = {
                method: a.close
            });
        a.message("CLOSING"),
        b(d, "kfe-active");
        var f = e._fileWidget.lastScrollTop;
        "undefined" != typeof f && c && (d.scrollTop = f),
        a.display_backdrop && (k.style.display = "none",
        d.style.overflow = l),
        a._fire("close")
    }
    ,
    ...
    e._dropzone = function (a) {
        ...
        this.clickExplorer = e.explorer(a),
        this.dropExplorerFrame = h[this.dropExplorer.exp_id],
        this.clickExplorerFrame = h[this.clickExplorer.exp_id],
    ...
    e._dropzone.prototype._configureFrame = function () {
        ...
        b.style.height = "100%",
        b.style.width = "100%",
        b.setAttribute("class", "kloudless-modal-dropzone"),
        b.onload = function () {
    ...
    e._dropzone.prototype.on = function (a, b) {
        return this.dropExplorer.on(a, b),
        this.clickExplorer.on(a, b),
        this
    }
    ,
    ...
    var p = {
            ...
            var b = new Date
              , c = setInterval(function () {
                ...
                a.progress = e;
                    ...
                    a.step(f),
                1 == e && (clearInterval(c),
                "undefined" != typeof a.complete && a.complete())
                }
            , a.delay || 10)
        },
        fadeOut: function (a, b) {
            ...
            this.animate({
                duration: b.duration,
                delta: function (a) {
                    return a = this.progress,
                    p.easing.quadratic(a)
                },
                complete: b.complete,
                step: function (b) {
                    a.style.opacity = c - b
...
function () {
    ...
    !Element.prototype.addEventListener) {
        var a = []
          , b = function (b, c) {
              ...
              , e = function (a) {
                ...
                a.currentTarget = d,
                c.handleEvent ? c.handleEvent(a) : c.call(d, a)
                    }
            ;
                this.attachEvent("on" + b, e),
            a.push({
                    object: this,
                    type: b,
                    listener: c,
        ...
        Element.prototype.removeEventListener = c,
        window.HTMLDocument && (window.HTMLDocument.prototype.addEventListener = b,
        window.HTMLDocument.prototype.removeEventListener = c),
        window.Window && (window.Window.prototype.addEventListener = b,
        window.Window.prototype.removeEventListener = c)
    }
